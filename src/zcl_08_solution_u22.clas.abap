CLASS zcl_08_solution_u22 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_08_solution_u22 IMPLEMENTATION.
...
*                    data = pass_flight->lif_output~get_output( ) ). "Ex. 22
                     data = pass_flight->get_output( ) ).            "Ex. 22
      ELSE.
...
*                    data = cargo_flight->lif_output~get_output( ) ).    "Ex. 22
                    data = cargo_flight->get_output( ) ).                "Ex. 22
      ELSE.
