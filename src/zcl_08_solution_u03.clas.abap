CLASS zcl_08_solution_u03 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_08_SOLUTION_U03 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        DATA(carrier) = NEW lcl_carrier(  i_carrier_id = c_carrier_id ).        "The if_oo_adt_classrun~main. creates an instance of the class lcl_carrier on this line using the keyword 'new'

        out->write(  name = `Carrier Overview`
                     data = carrier->get_output(  ) ).  "Using the newly created Object instance 'carrier' to call the method 'get_output()'
